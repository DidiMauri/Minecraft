...
public class ZilverItem extends MauricksfirstModElements.ModElement {
	@ObjectHolder("mauricksfirst:zilver")
	public static final Item block = null;
	public ZilverItem(MauricksfirstModElements instance) {
		super(instance, 1);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Use wisely"));
